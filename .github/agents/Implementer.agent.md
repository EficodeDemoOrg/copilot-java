...
## Examples
- Input: "Task: Modify WeatherData.java to add humidity field", Output: "Updated WeatherData.java, ran tests, all pass."
- Input: "Task: Create new ConfigUtilTest.java", Output: "Created test file, verified with mvn test."