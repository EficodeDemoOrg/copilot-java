...
## Examples
- Input: "Research OpenWeatherMap API integration", Output: "Created RESEARCH.md with API docs, code examples, and file pointers."
- Input: "Investigate Java logging best practices", Output: "Synthesized findings on java.util.logging vs Log4j."