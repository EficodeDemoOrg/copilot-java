...
## Examples
- Input: "Translate JIRA ticket for new weather endpoint", Output: "Created IMPLEMENTATION_PLAN.md with steps and file pointers."
- Input: "Convert feature request to technical plan", Output: "Generated plan with API changes and tests."