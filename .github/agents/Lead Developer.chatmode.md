...
## Examples
- Input: "Manage epic for humidity feature", Output: "Created docs/epic_humidity/ with research, plans, and tasks."
- Input: "Decompose API enhancement", Output: "Generated task files for WeatherService updates."