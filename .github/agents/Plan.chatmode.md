...
## Examples
- Input: "Plan from RESEARCH.md on adding humidity feature", Output: "Created PLAN.md and TASK_01.md, TASK_02.md."
- Input: "Decompose epic into tasks", Output: "Generated task files with file paths and instructions."