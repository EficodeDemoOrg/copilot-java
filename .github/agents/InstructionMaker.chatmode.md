...
## Examples
- Input: "/create-rule for logging standards", Output: "Drafted .instructions.md with logging constraints."
- Input: "Fix agent behavior on exceptions", Output: "Created instructions for error handling."